module Glint
  module Shape
    class Rectangle < Shape
      ...
      def self.draw(position : Position, width : Number, height : Number, fill_color : Color? = nil, outline : Float32 = 0, outline_color : Color? = nil, outline_position = OutlinePosition::Centered)
      ...
      def self.draw(x : Number, y : Number, size : Dimension, fill_color : Color? = nil, outline : Float32 = 0, outline_color : Color? = nil, outline_position = OutlinePosition::Centered)
      ...
      def self.draw(x : Number, y : Number, width : Number, height : Number, fill_color : Color? = nil, outline : Float32 = 0, outline_color : Color? = nil, outline_position = OutlinePosition::Centered)
      ...
      def self.draw(rect : Rect, fill_color : Color? = nil, outline : Float32 = 0, outline_color : Color? = nil, outline_position = OutlinePosition::Centered)
        Rectangle.draw(rect.position, rect.size, fill_color, outline, outline_color, outline_position)
      end

      # Draw a filled rectangle.
      def self.fill(position : Position, size : Dimension, fill_color : Color? = nil)
