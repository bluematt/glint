...
# Creates a `Glint::Color` from a `Raylib::Color`.
#
# ```
# # Example:
...
# red = color(255, 0, 0)
# ```
def color(r : Number, g : Number, b : Number, a : Number = Glint::Color::MAXIMUM_VALUE)
  Glint::Color.new(r, g, b, a)
end
